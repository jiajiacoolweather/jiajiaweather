...
import com.jiajia.cooleather.app.db.CoolWeatherDB;
import com.jiajia.cooleather.app.model.City;
import com.jiajia.cooleather.app.model.County;
import com.jiajia.cooleather.app.model.Province;
...
public class ChooseAreaActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//已经选择是城市且不是从WeatherActivity跳转过来,才会直接跳转到WeatherActivity
	...
	protected void queryCities() {
		cityList = coolWeatherDB.loadCities(selectedProvinces.getId());
		if (cityList.size() > 0) {
			dataList.clear();
			...
			Log.i("ProvinceName1", selectedProvinces.getProvinceName());
			currentLevel = LEVEL_CITY;
		} else {
			queryFromServer(selectedProvinces.getProvinceCode(), "city");
			Log.i("ProvinceName", selectedProvinces.getProvinceCode()+"");
		}
	}
			...
			public void onFinish(String response) {
				...
				if ("province".equals(type)) {
					...
					result = Utility.handleCitiesResponse(coolWeatherDB,
							response, selectedProvinces.getId());
	...
	/**
	 * 捕获Back按键,根据当前的级别来判断,此时应该返回市,县列表,还是直接退出
	 */
	@Override
