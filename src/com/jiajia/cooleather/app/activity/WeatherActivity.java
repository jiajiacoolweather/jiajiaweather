...
public class WeatherActivity extends Activity implements OnClickListener {
	...
	private void queryFromServer(final String address, final String type) {
		HttpUtil.sendHttpRequest(address, new HttpCallbackListener() {
			...
			public void onError(Exception e) {
				runOnUiThread(new Runnable() {
					public void run() {
						publishText.setText("同步失败,请检查网络!");
					}
				});
			}
		});
	...
	private void showWeather() {
		SharedPreferences presf = PreferenceManager
				.getDefaultSharedPreferences(this);
		cityNameText.setText(presf.getString("city_name", ""));
		temp1Text.setText(presf.getString("temp1", ""));
		temp2Text.setText(presf.getString("temp2", ""));
		weatherDespText.setText(presf.getString("weather_desp", ""));
		publishText.setText("今天" + presf.getString("publish_time", "") + "发布");
